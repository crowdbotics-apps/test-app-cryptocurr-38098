...
## Project Structure
    ...
    ├── test_app_cryptocurr_38098  # Django project configurations
...
1. Clone this repo and `cd test_app_cryptocurr_38098`
...
2. Clone this repo and `cd test_app_cryptocurr_38098`
